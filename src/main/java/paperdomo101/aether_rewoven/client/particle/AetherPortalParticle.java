...
public class AetherPortalParticle extends SpriteBillboardParticle {
    private final double startX;
    private final double startY;
    private final double startZ;

    public AetherPortalParticle(ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
        ...
        this.colorRed = j * 0.2F;
        this.colorGreen = j * 0.5F;
        this.colorBlue = j;
